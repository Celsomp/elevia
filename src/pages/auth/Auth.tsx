    ...
    return (
      <div className="flex min-h-svh flex-col items-center justify-center bg-background px-4">
        <div className="text-center">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-sunflower/20 text-4xl">
            📧
          </div>
          <h2 className="font-display text-2xl font-bold text-foreground">Verifica o teu email</h2>
          <p className="mt-3 max-w-xs font-body text-sm text-muted-foreground">
            Enviámos uma confirmação para <strong>{email}</strong>. Clica no link para ativar a tua conta.
          </p>
          <button
            onClick={() => { setEmailSent(false); switchMode('login') }}
            className="mt-6 font-body text-sm font-medium text-sunflower-dark hover:underline"
          >
            Já confirmei → Entrar
          </button>
        </div>
        ...
        {mode === 'login' ? (
          <>
            ...
            <button
              ...
              className="font-medium text-sunflower-dark hover:underline"
            >
              Criar conta
            </button>
          </>
